...
<body class="font-poppins antialiased">
  ...
  <form action="<?=BASE_PATH?>account/dashboard/admin/config/addUser.php" method="post"  enctype="multipart/form-data" class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
  <div class="heading text-center font-bold text-2xl m-5 text-gray-800">New User</div>
    <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" placeholder="Username" required="" id="username" name="username"/>
    <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" type="text" placeholder="Email" required="" id="email"  name="email"/>
    <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" type="password" placeholder="Password" required="" id="password" name="password" />
    <!-- icons -->
    <div class="icons flex text-gray-500 m-2">
      
      
      <div class="count ml-auto text-gray-400 text-xs font-semibold"></div>
    </div>
    <!-- buttons -->
