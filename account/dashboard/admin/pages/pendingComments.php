          ...
          <div class="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
            <div class="sm:flex sm:items-center sm:justify-between sm:space-x-5">
              <div class="flex items-center flex-1 min-w-0">
                <img
                    src="<?=BASE_PATH ?>assets/images/events/<?= $blogImg ?>" class="flex-shrink-0 object-cover rounded-full btn- w-10 h-10"/>
              ...
              <button onclick="window.location.href='commentDetails/<?= $commentID ?>';" class="bg-red-800 pt-2 pr-6 pb-2 pl-6 text-lg font-medium text-white transition-all duration-200 hover:bg-red-900 rounded-lg">View Comment</button>
