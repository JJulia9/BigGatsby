...
<section class="bg-white dark:bg-neutral-500">

    <div class="flex justify-center blog-mob">
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <div class="w-full">
                <h1 class="text-2xl font-semibold tracking-wider text-red-800 capitalize dark:text-red-800">
                <?= $blogTitle ?>
                </h1>
                <p class="mt-4 text-white dark:text-white">Added on: <?= $blogCreated ?></p>
                <hr>
                <div class="mt-6">
                    <pre class="mt-4 text-gray-500 dark:text-white">
                        <?= $blogContent ?>
                    </pre>    
                </div>      
            </div>
			...
			<div class="flex justify-center px-6 my-6">
				...
				<div class="w-full xl:w-3/4 lg:w-11/12 flex">
					...
					<div
						...
						style="background-image: url('<?= BASE_PATH ?>assets/images/events/<?= $imgPath ?>')"
					></div>
					<!-- Col -->
                ...
                <div class="max-w-2xl mx-auto">
                    <form action="../account/dashboard/user/addComment.php?blog_id=<?= $blogID ?>" method="post">
                        ...
                        <div class="py-2 px-4 bg-white rounded-t-lg dark:bg-neutral-400">
                        ...
                        <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-neutral-400">
                            <label for="editor" class="sr-only"></label>
                            <textarea name="comment" id="editor" rows="8" class="block px-0 w-full border rounded shadow py-5 px-5 text-sm text-gray-800 bg-white border-0 dark:bg-neutral-500 focus:ring-0 dark:text-white dark:placeholder-white" placeholder="Add your comment" required></textarea>
                        </div>
                        <button 
                        type="submit" class="my-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-red-800 rounded-lg focus:ring-4 focus:ring-red-900 dark:focus:ring-red-900 hover:bg-red-800">
                            Comment
                        </button>
                    </form>
                </div>  
...
<div class="px-10 mx-10">
    <div class="bg-white p-4 rounded-lg shadow-xl py-8 mt-12">
        <h4 class="text-4xl font-bold text-red-800 tracking-widest uppercase text-center">Comments</h4>
                ...
                <div class="mt-4 flex">
                    <div>
                        ...
                        <div class="flex items-center h-16">
                            <span class="text-lg text-red-700 font-bold"><?= $cHeading ?></span>
                        </div>
