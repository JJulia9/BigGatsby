			...
			<div class="page page--preview">
				<div class="gridwrap">
					<div class="grid grid--layout-1">
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/1.jpg)"></div>
						<div class="grid__item" style="background-image: url<?= BASE_PATH ?>assets/images/2.jpg)"></div>
						<div class="grid__item" style="background-image: url<?= BASE_PATH ?>assets/images/3.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/4.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/5.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/6.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/7.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/8.jpg)"></div>
						<div class="grid__item" style="background-image: url(<?= BASE_PATH ?>assets/images/9.jpg)"></div>
					</div>
